...
void Encoder_Init(void){
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB,ENABLE);//左右电机编码器时钟接口
	
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM2,ENABLE);//左右电机编码器时钟
	...
	TIM_TimeBaseInit(TIM4,&TIM_TimeBaseInitStructure);//两个时钟初始化
